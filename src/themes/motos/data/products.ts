...
const SEEDS: ProductSeed[] = [
  ...
  { name: 'Kit de discos de embrague', brand: 'Worth Moto Parts Pro', categorySlug: 'transmision', subcategorySlug: 'embrague', priceClp: 39990, stock: 19, shortDescription: 'Discos de fibra orgánica para una transmisión de potencia suave.', specs: [['Piezas', '6 discos'], ['Material', 'Fibra orgánica']], compatIdx: [2, 11], rating: 4.5, reviewsCount: 21, warrantyMonths: 6 },
  { name: 'Correa de transmisión CVT', brand: 'Worth Moto Parts Pro', categorySlug: 'transmision', subcategorySlug: 'correas-cvt', priceClp: 27990, stock: 28, shortDescription: 'Correa CVT de alta resistencia para scooters automáticos.', specs: [['Ancho', '18 mm'], ['Largo', '743 mm']], compatIdx: [13], rating: 4.3, reviewsCount: 15, warrantyMonths: 3 },
  ...
  { name: 'Filtro de aire de papel OEM', brand: 'Worth Moto Parts Pro', categorySlug: 'filtros', subcategorySlug: 'filtros-aire', priceClp: 8990, stock: 55, shortDescription: 'Reemplazo directo de fábrica, filtrado de papel plisado.', specs: [['Tipo', 'Papel plisado'], ['Reemplazo directo', 'Sí']], compatIdx: [2], rating: 4.4, reviewsCount: 17, warrantyMonths: 0 },
  ...
  { name: 'Cámara de aire reforzada', brand: 'Worth Moto Parts Pro', categorySlug: 'neumaticos', subcategorySlug: 'camaras-aire', priceClp: 8990, stock: 80, shortDescription: 'Cámara de goma reforzada, resistente a pinchazos menores.', specs: [['Medida', '100/90-18'], ['Válvula', 'TR4']], compatIdx: [6], rating: 4.2, reviewsCount: 24, warrantyMonths: 0 },
  { name: 'Kit de rodamientos de rueda', brand: 'Worth Moto Parts Pro', categorySlug: 'neumaticos', subcategorySlug: 'rodamientos-rueda', priceClp: 14990, stock: 48, shortDescription: 'Rodamientos sellados para un giro de rueda suave y silencioso.', specs: [['Piezas', '2 rodamientos + retén'], ['Medida', '6204 2RS']], compatIdx: [0, 5], rating: 4.5, reviewsCount: 20, warrantyMonths: 6 },

  // Escapes
  { name: 'Silenciador slip-on deportivo', brand: 'Worth Racing', categorySlug: 'escapes', subcategorySlug: 'silenciadores', priceClp: 149990, compareAtPriceClp: 169990, stock: 8, shortDescription: 'Silenciador en acero inoxidable con sonido deportivo grave.', specs: [['Material', 'Acero inoxidable'], ['Sonido', 'Deportivo grave']], compatIdx: [5, 11], rating: 4.6, reviewsCount: 33, warrantyMonths: 12, isFeatured: true },
  { name: 'Colector 4 en 1', brand: 'Worth Racing', categorySlug: 'escapes', subcategorySlug: 'colectores', priceClp: 189990, stock: 5, shortDescription: 'Colector de acero pulido con diseño 4 en 1 para mejor respuesta.', specs: [['Material', 'Acero pulido'], ['Diseño', '4 en 1']], compatIdx: [9], rating: 4.4, reviewsCount: 9, warrantyMonths: 12 },
  { name: 'Sistema de escape completo racing', brand: 'Worth Racing', categorySlug: 'escapes', subcategorySlug: 'sistemas-completos', priceClp: 289990, stock: 4, shortDescription: 'Sistema completo que reduce peso y mejora el sonido de escape.', specs: [['Peso', '-1.8 kg vs. OEM'], ['Incluye', 'Colector + silenciador']], compatIdx: [0], rating: 4.7, reviewsCount: 14, warrantyMonths: 12 },
  { name: 'Empaque de escape universal', brand: 'Worth Moto Parts Pro', categorySlug: 'escapes', subcategorySlug: 'empaques-escape', priceClp: 3990, stock: 100, shortDescription: 'Empaque de fibra grafitada para sellar uniones de escape.', specs: [['Material', 'Fibra grafitada'], ['Diámetro', '38-42 mm']], compatIdx: [], rating: 4.3, reviewsCount: 31, warrantyMonths: 0 },

  // Carrocería y plásticos
  { name: 'Kit de carenado lateral', brand: 'Worth Moto Parts Pro', categorySlug: 'carroceria', subcategorySlug: 'carenados', priceClp: 129990, stock: 9, shortDescription: 'Carenado en ABS inyectado, listo para pintar y adaptar.', specs: [['Material', 'ABS inyectado'], ['Pintura', 'Lista para pintar']], compatIdx: [0], rating: 4.3, reviewsCount: 16, warrantyMonths: 3 },
  { name: 'Guardabarro delantero', brand: 'Worth Moto Parts Pro', categorySlug: 'carroceria', subcategorySlug: 'guardabarros', priceClp: 24990, stock: 22, shortDescription: 'Guardabarro robusto en plástico ABS de reemplazo directo.', specs: [['Material', 'Plástico ABS'], ['Color', 'Negro mate']], compatIdx: [6], rating: 4.4, reviewsCount: 19, warrantyMonths: 3 },
  { name: 'Asiento doble tapizado', brand: 'Worth Moto Parts Pro', categorySlug: 'carroceria', subcategorySlug: 'asientos', priceClp: 59990, stock: 12, shortDescription: 'Asiento con tapiz antideslizante y espuma de alta densidad.', specs: [['Tapiz', 'Antideslizante'], ['Espuma', 'Alta densidad']], compatIdx: [7], rating: 4.6, reviewsCount: 27, warrantyMonths: 6 },
  { name: 'Par de espejos retrovisores deportivos', brand: 'Worth Moto Parts Pro', categorySlug: 'carroceria', subcategorySlug: 'manillas-espejos', priceClp: 17990, stock: 38, shortDescription: 'Espejos de diseño deportivo, ajuste universal izquierdo y derecho.', specs: [['Rosca', '10 mm'], ['Ajuste', 'Universal izq/der']], compatIdx: [], rating: 4.2, reviewsCount: 44, warrantyMonths: 3 },
  ...
  { name: 'Par de direccionales LED', brand: 'Worth Moto Parts Pro', categorySlug: 'luces', subcategorySlug: 'direccionales', priceClp: 12990, stock: 50, shortDescription: 'Direccionales LED ámbar homologadas, bajo consumo.', specs: [['Tipo', 'LED ámbar'], ['Homologación', 'E-mark']], compatIdx: [], rating: 4.4, reviewsCount: 40, warrantyMonths: 6 },
  { name: 'Relay electrónico de 3 pines', brand: 'Worth Moto Parts Pro', categorySlug: 'luces', subcategorySlug: 'relays-intermitentes', priceClp: 4990, stock: 65, shortDescription: 'Relay electrónico compatible con luces LED y halógenas.', specs: [['Compatibilidad', 'LED y halógeno'], ['Pines', '3']], compatIdx: [], rating: 4.1, reviewsCount: 13, warrantyMonths: 3 },
  ...
  { name: 'Tablero digital velocímetro', brand: 'Worth Moto Parts Pro', categorySlug: 'instrumentos', subcategorySlug: 'velocimetros-tacometros', priceClp: 54990, compareAtPriceClp: 64990, stock: 9, shortDescription: 'Tablero digital retroiluminado con velocidad, RPM y nivel de combustible.', specs: [['Pantalla', 'LCD retroiluminada'], ['Funciones', 'Velocidad / RPM / combustible']], compatIdx: [5], rating: 4.5, reviewsCount: 19, warrantyMonths: 6, isFeatured: true },
  { name: 'Cable de velocímetro', brand: 'Worth Moto Parts Pro', categorySlug: 'instrumentos', subcategorySlug: 'cables-velocimetro', priceClp: 6990, stock: 48, shortDescription: 'Cable flexible de repuesto para velocímetro mecánico.', specs: [['Largo', '90 cm'], ['Rosca', 'M10']], compatIdx: [7], rating: 4.2, reviewsCount: 14, warrantyMonths: 3 },
...
function buildProducts(): Product[] {
  return SEEDS.map((seed, index) => {
    ...
    return {
      ...
      sku: `WMP-${seed.categorySlug.slice(0, 3).toUpperCase()}-${String(index + 1).padStart(4, '0')}`,
      name: seed.name,
      brand: seed.brand,
