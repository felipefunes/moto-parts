...
| 2026-09-10 | Wire CategoryNav/CategoryShowcase/Footer/FilterSidebar to catalogService | — (no estimate given) | ~49 min, not meaningful | Measured PR #25 merged (21:00 UTC) → this one opened. Most of the window was in `rpm-parts-backend` (v0.2.0: categories now include subcategories, plus the CORS fix that manual browser verification surfaced), not this repo. |
